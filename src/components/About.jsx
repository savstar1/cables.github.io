...
export const About = () => {
    return (
      ...
      <p className="text-base text-gray-700 text-center md:text-3xl pt-10 font-bold">
        ...
        <div className="grid gap-5 row-gap-8 lg:grid-cols-2">
          <div className="flex flex-col justify-center">
            <div className="max-w-xl mb-6">
              ...
              Sav'star is a <b>wire manufacturing company</b> which was established in <b>2007</b>. Its manufacturing plants are located in Bawana industrial area, Delhi. The <b>experience</b> of more than <b>15+ years</b> in this field helps us to give our customers the <b>best quality wires</b> and cables. Sav'star Cables is a <b>leading provider</b> of <b>high-quality</b> electrical wires and cables for commercial and residential use. We offer a wide range of products all designed to meet the specific needs of our customers. With a focus on <b>quality, safety, and reliability</b>, our cables are built to withstand harsh environments and <b>deliver consistent performance</b>. Our experienced team of professionals is committed to providing exceptional <b>customer service</b> and <b>technical support</b>, ensuring that our customers have the products they need, when they need them. Whether you are looking to power up your home or your business, Sav'star Cables has the solution for you.
              </p>
            </div>
